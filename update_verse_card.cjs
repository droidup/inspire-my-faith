...
export default function VerseOfTheDayCard({ 
  ...
  return (
    <div className="bg-white rounded-[24px] shadow-sm border border-stone-100 overflow-hidden flex flex-col h-full relative group col-span-1 md:col-span-2 transition-all">
      {/* Top Section: Verse */}
      <div className="p-8 sm:p-10 bg-white text-slate-800 relative flex-1 flex flex-col justify-center border-b border-stone-100">
        <div className="absolute top-0 right-0 p-6 opacity-5 pointer-events-none">
          <Sparkles size={120} className="text-[#c2094c]" />
        </div>
      ...
      <div className="p-6 sm:px-10 sm:py-8 flex flex-col bg-stone-50/50">
        <h4 className="font-bold uppercase tracking-[0.2em] text-stone-400 mb-3 flex items-center gap-2 text-[11px]">
          <Sparkles size={14} className="text-[#c2094c]" />
          Make it happen
        </h4>
...
`;
fs.writeFileSync('src/components/VerseOfTheDayCard.tsx', c);
